...
function medplus_scripts() {
	...
	wp_enqueue_style( 'medplus-responsive', get_template_directory_uri()."/css/responsive.css" );		
	wp_enqueue_style( 'medplus-default-style', get_template_directory_uri()."/css/default.css" );
	wp_enqueue_script( 'jquery-nivo-slider', get_template_directory_uri() . '/js/jquery.nivo.slider.js', array('jquery') );
	wp_enqueue_script( 'medplus-custom', get_template_directory_uri() . '/js/custom.js' );	
 ...
 */
function medplus_skip_link_focus_fix() {  
...
add_action( 'wp_print_footer_scripts', 'medplus_skip_link_focus_fix' );