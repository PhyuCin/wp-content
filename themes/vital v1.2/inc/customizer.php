...
function cover_image_customize($wp_customize){
	//add setting
	$wp_customize->add_setting('cover_image_text', array(
        'transport'         => 'refresh',
        'height'         => 325,
    ));
	
	$wp_customize->add_setting('cover_button_text', array(
        'transport'         => 'refresh',
        'height'         => 325,
    ));
	...
	// Add Section
    $wp_customize->add_section('coverImage', array(
        'title'             => __('Cover Image', 'name-theme'), 
        'priority'          => 70,
    ));
	// Add Controls
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'cover_image_text', array(
        'label'             => __('Cover Image Text', 'name-theme'),
        'section'           => 'coverImage',
        'settings'          => 'cover_image_text',    
    )));
    $wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'cover_button_text', array(
        'label'             => __('Text for button', 'name-theme'),
        'section'           => 'coverImage',
        'settings'          => 'cover_button_text',
    )));    
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'cover_image', array(
        'label'             => __('Cover Image', 'name-theme'),
        'section'           => 'coverImage',
        'settings'          => 'cover_image',
    )));    
}
add_action('customize_register', 'cover_image_customize');