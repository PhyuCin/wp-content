	...
	<div class="container">
        <div class="page-content">		
			...
			<div class="read-moresec">
        		<a href="<?php echo esc_url(home_url()); ?>" class="button hvr-sweep-to-right"><?php esc_html_e( 'Return to the home page', 'vw-charity-ngo' ); ?><span class="screen-reader-text"><?php esc_html_e( 'Return to the home page','vw-charity-ngo' );?></span></a>
			</div>
